  ...
  return (
    <div className="container">
      <div className="row border py-2">
        ...
        <div className="col-sm-12 col-md-5">
          <button type="button" name="btn" id="view" className="btn btn-primary mx-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <button type="button" name="btn" id="delete" className="btn btn-danger mx-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <button type="button" name="btn" id="edit" className="btn btn-success mx-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
