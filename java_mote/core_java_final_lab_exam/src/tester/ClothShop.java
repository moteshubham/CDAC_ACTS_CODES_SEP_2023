...
import static utils.ClothValidationRules.*;
...
public class ClothShop {
	...
	public static void main(String[] args) {
		...
		clothes.add(new Cloth(enums.Category.MENS_SHIRTS, 30, enums.Size.XL, 1600, "Van Heusen", "Yellow"));
		clothes.add(new Cloth(enums.Category.WOMENS_JEANS, 50, enums.Size.L, 900, "Wrangler", "Black"));
		clothes.add(new Cloth(enums.Category.MENS_TSHIRT, 20, enums.Size.S, 1500, "Being Human", "White"));
		clothes.add(new Cloth(enums.Category.WOMENS_JEANS, 50, enums.Size.M, 1200, "Pepe Jeans", "Red"));
		clothes.add(new Cloth(enums.Category.OTHER, 0, enums.Size.M, 120, " Jeans", "Red"));
		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			while (!exit) {
				...
				System.out.println("4. Remove Clothers which are out of stock for Last 2 month");
				...
				case 1:
					...
					Cloth validatedCloth = validateCloth(sc.next(), sc.nextInt(), sc.next(), sc.nextDouble(), sc.next(),
							sc.next(), clothes);
