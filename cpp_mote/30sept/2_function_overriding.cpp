...
int main()
{
	...
	Person p1;
	//p1.displayDetails();
	cout<<endl<<"Creating Student Object : s1"<<endl;
	Student s1;
	s1.displayDetails1();  //when function from base and derived have same name and type,derive class functino overrides base class function => this is function overriding
	//student display1 gets called
	s1.Person::displayDetails1();  //to call base function we need to call explicitely
	return 0;
}
